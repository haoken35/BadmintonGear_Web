...
export default function AdminFlashSaleItem({ flashsale, onDelete }) {
    const { t } = useLanguage();
    ...
    return (
        <tr className='bg-(--surface) text-(--text2) shadow-md border-b border-(--border) hover:bg-(--surface2) transition-colors duration-200'>
            <td className='text-(--primary) py-4 px-3 text-center'>{flashsale.id}</td>
            <td className='py-4 text-center'>{flashsale.name}</td>
            <td className='text-center'>{new Date(flashsale.start).toLocaleString("vi-VN", {
                year: 'numeric',
                month: '2-digit',
                day: '2-digit',
                hour: '2-digit',
            ...
            <td className='text-center'>{new Date(flashsale.end).toLocaleString("vi-VN", {
                year: 'numeric',
                month: '2-digit',
                day: '2-digit',
                hour: '2-digit',
