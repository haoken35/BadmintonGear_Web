                ...
                <div className="flex items-center gap-3 ">
                    {
                        user ? (<div className="flex items-center gap-2"
                            ...
                            <div className='flex flex-col gap-1'>
                                <a id="account" href="/account" className='text-(--text)'>{user.username}</a>
