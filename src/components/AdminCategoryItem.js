        ...
        <tr className='bg-(--surface) shadow-md border-b border-(--border) hover:bg-(--surface2) text-(--text2)'>
            ...
            <td className='py-4'>
                <div className='flex items-center gap-2'>
                    ...
                    <label className='font-medium text-(--text)'>{category.name}</label>
                </div>
            </td>
            ...
            <td >
                <div className='flex  items-center gap-3'>
                    <button onClick={() => window.location.href = `/categorydetail?id=${category.id}&&mode=view`}>
                    ...
                    <button onClick={() => window.location.href = `/categorydetail?id=${category.id}&&mode=edit`}>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
