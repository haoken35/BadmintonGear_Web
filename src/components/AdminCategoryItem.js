        ...
        <tr className='bg-white shadow-md border-b border-[#F0F1F3]'>
            ...
            <td >
                <div className='flex  items-center gap-3'>
                    <button onClick={() => window.location.href = `/admin/categorydetail?id=${category.id}&&mode=view`}>
                    ...
                    <button onClick={() => window.location.href = `/admin/categorydetail?id=${category.id}&&mode=edit`}>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
