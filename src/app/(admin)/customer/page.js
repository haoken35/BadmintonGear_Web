    ...
    <div className="font-inter">
      <div className="flex justify-between items-end">
        <div>
          ...
          <div id="roadmap" className="flex items-center mt-2">
            ...
            <a className="text-[#667085]" href="/customer">Customer List</a>
          </div>
        </div>
      ...
      <div className='mt-5 flex justify-between items-center'>
        <div className='flex gap-1 items-center bg-(--surface) rounded-md px-4 border border-(--border)'>
          ...
          <input id='searchInput' type='text' placeholder='Search customer...' className='text-(--text) px-2 py-2 outline-none' onChange={handleSearchChange} />
        </div>
      ...
      {showFilters && (
        <div className="absolute right-10 mt-2 bg-(--surface) p-6 rounded-md shadow-lg min-w-[350px] z-50 ">
          <h2 className="text-xl font-bold mb-4">Filter Customers</h2>

          <div className="mb-4">
            <label className="block mb-2">Status</label>
            <select className="w-full border rounded p-2">
              <option className="bg-(--surface) text-(--text)" value="">All</option>
              <option className="bg-(--surface) text-(--text)" value="active">Active</option>
              <option className="bg-(--surface) text-(--text)" value="blocked">Blocked</option>
            </select>
          </div>
