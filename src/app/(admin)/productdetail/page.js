            ...
            <div className='flex justify-between items-end'>
                <div>
                    ...
                    <div id="roadmap" className="flex items-center mt-2">
                        ...
                        <a className="text-(--muted)" href="/addproduct">Product Details</a>
                    </div>
                ...
                <div className='w-2/3 '>
                    <div className='bg-(--surface) shadow-md rounded-lg p-5'>
                        ...
                        <div className='mt-2 gap-1'>
                            ...
                            <input
                                type="text"
                                className='border border-(--border) bg-(--surface2) text-(--text2) rounded-md w-full px-3 py-2  outline-none'
                        ...
                        <div className='mt-2 gap-1'>
                            ...
                            <textarea
                                className='border border-(--border) bg-(--surface2) text-(--text2) rounded-md w-full px-3 py-2 resize-none  outline-none'
                        ...
                        >
                            ...
                            {mode === 'edit' && (
                                <div className='flex flex-col items-center mt-4 gap-5 mb-5'>
                                    ...
                                    <div>
                                        <label htmlFor='upload-image' className='text-(--primary) bg-[#FBE3CA] rounded-lg px-4 py-2'>Add Image</label>
                                        <input
                                            id='upload-image'
                    ...
                    <div className='bg-(--surface) shadow-md rounded-lg p-5 mt-5'>
                        ...
                        <div className='mt-2 gap-1'>
                            ...
                            <div className='border border-(--border) bg-(--surface2) rounded-md w-full px-3 py-2 flex items-center gap-2'>
                        ...
                        <div className='mt-2 gap-1'>
                            ...
                            <input
                                type="number"
                                className='border border-(--border) bg-(--surface2) rounded-md w-full px-3 py-2  outline-none'
                ...
                <div className='w-4/15'>
                    <div className='bg-(--surface) shadow-md rounded-lg p-5 w-full'>
                        ...
                        <div className=' gap-1 mt-2'>
                            ...
                            <select
                                className='w-full border border-(--border) bg-(--surface2) rounded-md px-4 py-2 outline-none '
                            ...
                            >
                                ...
                                {category.map((item, index) => (
                                    <option key={index} className='text-(--text) bg-(--surface2)' value={item.id}>{item.name}</option>
                                ))}
                            </select>
